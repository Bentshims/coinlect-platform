  ...
  return (
    <div className="space-y-8 ">
      ...
      <div className="flex gap-2">
        ...
        <div className="h-1 flex-1 rounded-full bg-[#FF9900]" />
        <div className="h-1 flex-1 rounded-full bg-[#D9D9D9]/20" />
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            {...register("email")}
            autoFocus
            className="h-14 bg-transparent border-[#D9D9D9]/30 text-white placeholder:text-[#D9D9D9]/50 focus:border-[#FF9900] focus:ring-[#FF9900]"
          />
          {errors.email && (
